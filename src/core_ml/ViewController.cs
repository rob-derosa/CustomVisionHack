...
namespace CustomVision
{
	public partial class ViewController : UIViewController, IAVCaptureVideoDataOutputSampleBufferDelegate
	{
		...
		TimeSpan pace = new TimeSpan(0, 0, 0, 0, 1800); // in milliseconds, classification will not repeat faster than this value
		...
		public VNRequest[] ClassificationRequest
		{
			get
			{
				if (model == null)
				{
					var modelPath = NSBundle.MainBundle.GetUrlForResource("shoes", "mlmodelc");
